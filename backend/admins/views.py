...
os.environ["GOOGLE_API_KEY"] = "AIzaSyCfoFYP73isNhHoEWPYkAtC15YPJ6GHc80"
...
class GenerateContentView(APIView):
    def post(self, request):
        ...
        content_prompt = """
Act as an expert instructor with 15 years of experience in content generation and generate detailed content for the following module and submodules. The content should be comprehensive and structured like a lecture, including explanations, examples, and key points.
...
3. Use clear and concise language suitable for {level} level students.
...
7. Put correct heading and subheading for the content you give, make it more interesting and easy to read.
8. It should not be in markdown format or contain any escape characters.
9. It must be a clean JSON object with the specified keys and values.
